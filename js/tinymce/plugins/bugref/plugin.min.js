;(function (tinymce, $) {
    ...
    AutoComplete.prototype = {
        ...
        matcher: function(item) {
            /*console.log("Working with: " + item[this.options.queryBy]);
            console.log("But I am REALLY working with: " + item[this.options.queryBy].toLowerCase());
            console.log("To sse the indexOf: " + this.query.toLowerCase());*/
            var x = item[this.options.queryBy].toLowerCase().indexOf(this.query.toLowerCase());
        ...
        insert: function(item) {
			console.log(item);
            return '<a href="?bid=' + item.id +'">' + item.name + '</a>';
             },
    ...
    tinymce.create('tinymce.plugins.Bugref', {

        init: function (ed, url) {

            var autoComplete,
                autoCompleteData = ed.getParam('bugref');
    ...
    tinymce.PluginManager.add('bugref', tinymce.plugins.Bugref);
